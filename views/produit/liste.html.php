...
<body>
  ...
  <main>
    <h2 class="text-center mt-3">Liste des produits</h2>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form>
                <div class="mb-3">
                  <label for="name" class="col-form-label">Libelle</label>
                  <input type="text" name="libellep" class="form-control" id="nameInput">
                ...
                <div class="mb-3">
                  <label for="conversionInput" class="col-form-label">Quantite en stock:</label>
                  <input type="number" name="qtestockp" class="form-control" id="telInput"></input>
                </div>
        ...
        <tbody>
          <?php foreach ($produits as $produit) : ?>
            <tr>
              ...
              <td> <?php echo $produit->libellep ?> </td>
              <td> <?php echo $produit->qtestockp ?> </td>
            </tr>
          <?php endforeach ?>
